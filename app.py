...
def resolve_ticker_from_name(name_or_ticker):
    ...
    COMMON_TICKERS = {
        ...
        "CITIGROUP INC": "C","BNP PARIBAS": "BNP.PA","SOCIETE GENERALE": "GLE.PA",
        "CREDIT AGRICOLE": "ACA.PA","DEUTSCHE BANK AG": "DBK.DE","COMMERZBANK AG": "CBK.DE",
        "UBS GROUP AG": "UBSG.SW","CREDIT SUISSE": "CSGN.SW","HSBC HOLDINGS": "HSBA.L",
  ...
  # --- BANQUES RÉGIONALES ET SPÉCIALISÉES (US & EU) ---
        ...
        "BANCO SANTANDER": "SAN",:"BBVA": "BBVA","UNICREDIT SPA": "UCG.MI",
